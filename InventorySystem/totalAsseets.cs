...
{
    public partial class totalAsseets : Form
    {
        ...
        private void totalAsseets_Load(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                con.Open();
                string qryView = "SELECT id,category,brand,specs,serial,remarks,status from tbl_assets";
